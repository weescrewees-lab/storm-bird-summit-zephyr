...
//#region node_modules/.nitro/vite/services/ssr/assets/router--XXhtfxk.js
...
var styles_default = "/assets/styles-BQz_e-w5.css";
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "High-resolution satellite freight map for logistics managers across Europe, Russia, and China."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-D61Wubs-.mjs");
